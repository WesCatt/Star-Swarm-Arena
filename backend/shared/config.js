...
export const ITEM_TYPES = [
  ...
  { id: 'cooldown-haste', icon: 'bolt', name: 'Half Cooldown', description: 'Current skill cooldowns are halved, and new cooldowns stay halved for 6 seconds.', duration: 6, accent: '#9cc0ff' },
];
